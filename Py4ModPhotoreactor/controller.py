...
# -*- coding: utf-8 -*-
"""
    `Py4ModPhotoreactor` implements the  class:
    `Controller`

    The module Py4ModPhotoreactor runs the hardware Py4ModPhotoreactor of the modular photoreactor as an instance of the `Controller`
    class. 
"""
...
class Controller:
    ...
    import threading
    import re
    import Py4ModPhotoreactor.modules as modules
    """
    A class to operate the Py4ModPhotoreactor of the modular photoreactor.
